...
export const peopleCardSchema: Schema = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: "group",
      fields: [
        { key: "max_hydration", label: "Maximum Hydration", type: "number", range: { min: 1, max: 100 }, required: true },
        { key: "hydration_depletion_rate", label: "Hydration Depletion Rate (per cycle)", type: "number", range: { min: 0.1, max: 5 }, required: true },
        {
          key: "replenishment_options",
          label: "Replenishment Options",
          type: "group",
          fields: [
            ...
            },
            {
              ...
              type: "group",
              fields: [
                { key: "hydration_restored", label: "Hydration Restored", type: "number", range: { min: 1, max: 50 }, required: false },
                { key: "yield_bonus", label: "Yield Bonus", type: "number", range: { min: 0, max: 10 }, required: false },
                { key: "duration", label: "Bonus Duration (Turns)", type: "number", range: { min: 0, max: 10 }, required: false },
              ],
            },
